...
Original file is located at
    https://colab.research.google.com/drive/1cuWP9Qc-tjHAORuq3wKWu_m64FNEOskI
"""
...
discriminator_optimizer = keras.optimizers.Adam(learning_rate=0.00015, clipvalue=1.0, beta_1=0.5)
...
gan_optimizer = keras.optimizers.Adam(learning_rate=0.0001, clipvalue=1.0, beta_1=0.5)
...
plt.figure(figsize=(10, 6))
plt.hlines(np.average(x_train), min(steps_plotted), max(steps_plotted), label='x_train average', color='red')
plt.hlines(np.median(x_train), min(steps_plotted), max(steps_plotted), label='x_train median', color='green')
plt.plot(steps_plotted, average, label='Generator output average', alpha = 0.5, color='red')
plt.plot(steps_plotted, median, label='Generator output median', alpha = 0.5, color='green')
...
plt.ylim(-1, 1)
plt.grid(True)
plt.savefig('average_median.png')
plt.show()
